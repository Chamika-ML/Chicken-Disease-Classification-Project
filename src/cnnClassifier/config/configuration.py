...
from cnnClassifier.entity.confing_entity import DataIngestionConfig, PrepareBaseModelConfig,PrepareCallbacksConfig,TrainingConfig
...
class ConfigurationManager:
    ...
    def get_prepare_base_model_cofig(self)->PrepareBaseModelConfig:
        ...
        # create the artifacts/prepare_base_model folder
        create_directories([config.root_dir])
